...
<body>
	...
	$( document ).ready(function() {
	    var url ="get-info-office.php?groupid="+get_param('groupid')+"&"+"groupflg="+get_param('groupflg');
	...
	$('#infoTable').on('click', 'tbody tr', function(event) {
	 ...
	 function onClickedUpdate() {
		...
		sessionStorage.setItem(''+'session_'+get_param('groupid')+'-'+get_param('groupflg'), arrOffices);
	       var sendInfo = {
